...
public class Cat {
    ...
    private void loadSprite() {
        try {
            sprite = ImageIO.read(new File("res/sprites/cat/babi.png"));
            walking = ImageIO.read(new File("res/sprites/cat/walking.png"));
            pawing = ImageIO.read(new File("res/sprites/cat/paw.png"));
            headbutting = ImageIO.read(new File("res/sprites/cat/walking.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
